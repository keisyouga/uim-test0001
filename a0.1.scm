...
(define test0001-init-handler
  (lambda (id im arg)
    (let ((context (test0001-context-new id im)))
      ...
      (if (symbol-bound? 'test0001-lib-func0)
          (begin (uim-notify-info "test0001-lib-func0")
                 (test0001-lib-func0)))
      (if (symbol-bound? 'test0001-lib-func1)
          (begin (uim-notify-info "test0001-lib-func1")
                 (test0001-lib-func1 1)))
      (if (symbol-bound? 'test0001-lib-func2)
          (begin (uim-notify-info "test0001-lib-func2")
                 (test0001-lib-func2 1 2)))
      (if (symbol-bound? 'test0001-lib-func3)
          (begin (uim-notify-info "test0001-lib-func3")
                 (test0001-lib-func3 1 2 3)))
      (if (symbol-bound? 'test0001-lib-func4)
          (begin (uim-notify-info "test0001-lib-func4")
                 (test0001-lib-func4 1 2 3 4)))
      (if (symbol-bound? 'test0001-lib-func5)
          (begin (uim-notify-info "test0001-lib-func5")
                 (test0001-lib-func5 1 2 3 4 5)))
      context)))
